...
@ShardingAlgorithm
public class NuggetsBatchRepayExportAlgorithm implements PreciseShardingAlgorithm<Date> {

    public static final String NUGGETS_BATCH_REPAY_EXPORT_DETAIL = "nuggets_batch_repay_export_detail_";

    @Override
    public String doSharding(Collection<String> availableTargetNames,
                             PreciseShardingValue<Date> shardingValue) {
        String index = Utility.formatDate(shardingValue.getValue(), Constants.YYYYMM);
        return NUGGETS_BATCH_REPAY_EXPORT_DETAIL + index;
    }
}
